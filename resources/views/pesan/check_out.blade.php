			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						...
						<li><a class="nav-link" href="cart.html"><img src="frontend/images/cart.svg"></a></li>
					</ul>
				</div>
			</div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rp. {{ number_format($detail_penjualan->jumlah_harga) }}</td>
                                <td>
                                    <form action="{{ url('check-out') }}/{{ $detail_penjualan->id }}" method="post">
                                        @csrf
                                        {{ method_field('DELETE') }}
                            ...
                            <tr>
                                ...
                                <td><strong>Rp. {{ number_format($penjualan->jumlah_harga) }}</strong></td>
                                <td>
                                    <a href="{{ url('konfirmasi-check-out') }}" class="btn btn-sm btn-outline-dark flex-shrink-0 mb-2" onclick="return confirm('Anda yakin akan Check Out ?');">
                                         update
                                    </a><br>
                                    <a href="{{ url('konfirmasi-check-out') }}" class="btn btn-sm btn-outline-dark flex-shrink-0" onclick="return confirm('Anda yakin akan Check Out ?');">

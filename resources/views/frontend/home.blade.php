                    ...
                    <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item text-light" href="profile">Profil</a></li>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1>Welcome to <br><span clsas="d-block">Zeta Shop</span></h1>
                        <p class="mb-4">The future of Technology.</p>
                        <p><a href="/shop" class="btn btn-secondary me-2">Shop Now</a><a href="#explore"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    <h2 class="mb-4 section-title">Provides a variety of Devices.</h2>
                    <p class="mb-4">make your style according to your needs, look cool with your new device. </p>
    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="frontend/images/bg2.png" alt="Image" class="img-fluid">
                    </div>
                </div>
